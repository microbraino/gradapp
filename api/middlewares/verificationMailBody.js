                                                                    ...
                                                                    <table
                                                                        ...
                                                                        <tbody>
                                                                            <tr>
                                                                                <td>
                                                                                    <p
                                                                                        style="Margin:0px 0px 20px 0px;font-size:15px;line-height:23px;color:#102231">
                                                                                        Hi ${account.name},
                                                                                    </p>
                                                                                </td>
                                                                            </tr>
                                                                            ...
                                                                            <tr>
                                                                                <td>
                                                                                    <p
                                                                                        style="Margin:0px 0 20px 0;font-family:Arial,Helvetica,sans-serif;color:#363636;font-size:16px">
                                                                                        Or copy this link and paste in your web
                                                                                        browser:</p>
                                                                                    <p
